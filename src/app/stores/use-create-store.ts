...
import { ISubmitStoreFormRequest, ICreateStoreRequest } from "@/interfaces/store";

export function useCreateStore(toast: CreateToastFnReturn, fetchStores: () => void, supabase: SupabaseClient){
